...
struct QuantityTests {
    ...
    @Test func settingValueUsesCurrentUnit() {
    ...
    @Test func valueIsRoundedToFractionLength() {
    ...
    @Test func valueSurvivesRoundTrip() {
    ...
    @Test func alternativesCoverEachDimension() {
